...
@section('content')
    <x-headadmin title="Quản lí danh mục và tabs"></x-headadmin>
            ...
            <div class="modal-content">
                <form action="" method="POST" id="dataForm">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title">Thêm/chỉnh sửa danh mục và tabs</h4>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Tên và tabs</label>
                                            <input name="title_vi" class="form-control" id="title_vi" placeholder="Nhập tên">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Danh mục cha (không dành cho loại tab)</label>
                                    ...
                                    {{-- <input type="hidden" name="typeCate" id="typeCate" value="0"> --}}
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Loại</label>
                                            <div class="select2-purple">
    ...
    <script>
        $(document).ready(function() {
            ...
            load_data_ajax_datatables("{{ url('/cludmed/admin/data-categories') }}",DataLoadFirst);
            ...
            $('#insertData').click(function (e) {
                ...
                var url = '{{url("/cludmed/admin/quan-li-danh-muc-tour/them")}}';
                insert(url,dataForm);
                // location.reload();
            })
            ...
            $(document).on('click','.del',function (e){
                ...
                var id = $(this).data('id');
                console.log(id);
                var url = '{{url("/cludmed/admin/quan-li-danh-muc-tour/xoa")}}';
                del(url,id);
                // location.reload();
            })
            ...
            $(document).on('click','.update',async function (e){
                e.preventDefault();
                var id = $(this).data('id');
                var url = '{{url("/cludmed/admin/categories-detail")}}';
                // thông báo chờ
                Show_wait_announce();
                await $.ajax({
                    url:url,
